...
interface AuthContextType {
  ...
  // handleLogin removed as login is now page-based
...
export const AuthProvider: React.FC<{ children: ReactNode }> = ({ children }) => {
  ...
  const handleLogout = async () => {
    setIsLoadingAuth(true); // Technically, onAuthUserChanged will set it false after logout
    await signOutUser();
    // No need to setCurrentUser(null) here, onAuthUserChanged will do it.
  };
